...
LOADER_CONFIG_KEYS = {
    ...
    'PDF_OCR_ENABLE': 'rag.pdf_ocr_enable',
    'PDF_OCR_TEXT_THRESHOLD': 'rag.pdf_ocr_text_threshold',
    'PDF_OCR_DPI': 'rag.pdf_ocr_dpi',
    'PDF_OCR_REC_MODEL_URL': 'rag.pdf_ocr_rec_model_url',
    'PDF_OCR_KEYS_PATH': 'rag.pdf_ocr_keys_path',
