			...
			<div class="">
				<div class="mb-3.5">
					...
					<div class="mb-2.5">
						...
						<!-- Fork: Discord / X / GitHub promo badges hidden, same as in
						     Settings/About.svelte. The «Documentation» link above is kept — an
						     admin operating this software genuinely needs the upstream docs. -->
						{#if false}
							<div class="mt-1">
